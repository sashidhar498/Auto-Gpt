...
make_new_function("i want you to understand yourself, i made you , you are an ai in my autogen project demo.py you conents are"+str(fetch_file_content("main.py"))+"try to make yourself better, if you think you are good enough then dont give any")